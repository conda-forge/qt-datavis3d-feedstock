...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/qt-datavis3d-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/qt-datavis3d-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add qt6-datavis3d
# for installing globally
pixi global install qt6-datavis3d
```
...
It is possible to list all of the versions of `qt6-datavis3d` available on your platform:
...
```
pixi search qt6-datavis3d --channel conda-forge
```
